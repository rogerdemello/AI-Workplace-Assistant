...
from ..schemas.chat import ConversationCreate, MessageCreate, MessageResponse, MessageSender as SchemaMessageSender
...
class ChatService:
    ...
    def _update_cache(self, conversation_id: UUID):
