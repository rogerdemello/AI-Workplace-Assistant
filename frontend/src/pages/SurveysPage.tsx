  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Slack', 'Email', 'Microsoft Teams', 'Zoom', 'In-person meetings'],
        required: true
      }
    ]
  },
    ...
    questions: [
      {
        ...
        options: ['Fully remote', 'Hybrid', 'Fully office'],
        required: true
      }
    ]
  }
...
export function SurveysPage() {
  ...
  // Filter active surveys for employees
        ...
        <Card className="max-w-md mx-auto">
          ...
          <CardContent className="text-center space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              {anonymous ? 'Your response was submitted anonymously.' : 'Thank you for your feedback!'}
            </p>
  ...
  if (currentView === 'take' && selectedSurvey) {
    const requiredAnswered = selectedSurvey.questions
      .filter(q => q.required)
        ...
        <Card>
          <CardHeader>
            ...
            {selectedSurvey.allow_anonymous && (
              <Badge variant="secondary" className="mt-2">Anonymous Response Allowed</Badge>
            )}
          </CardHeader>
              ...
              <div className="flex gap-4">
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) => setNewQuestion(prev => ({ ...prev, type: e.target.value as SurveyQuestion['type'] }))}
                  >
